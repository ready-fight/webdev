<?php
  class VideoDetailsFormProvider {
    ...
    public function createUploadForm() {
      $fileInput = $this->createFileUnput();
      $titleInput = $this->createTitleInput();
      $descriptionInput = $this->createDescriptionInput();
      $privateInput = $this->createPrivacyInput();
    ...
    private function createFileUnput() {
      return
    ...
    private function createUploadButton() {
      return "<button type='submit' class='btn btn-danger float-right' name='uploadButton'>Upload</button>";
    }
  }
?>
